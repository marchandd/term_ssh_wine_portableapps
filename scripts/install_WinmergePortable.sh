#!/bin/bash
#DM*20141219 WinMergePortable(2.14.0) English version succesfully based
...
winInstallFilePath='C:\Installers\WinMergePortable.paf.exe -q'
postInstallAliasScript="postInstall_AliasForWinmergePortable.sh"
downloadPattern=~/Downloads/WinMergePortable*.paf.exe
