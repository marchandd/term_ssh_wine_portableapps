#!/bin/bash
#DM*201412230Running after install_AntrenamerPortable.sh

#Specific alias Windows PortableApps registry
programName="antrenamer"
winProgramName="AntRenamerPortable"
wineStartCommand="wine start 'C:\PortableApps\AntRenamerPortable\AntRenamerPortable.exe'"
